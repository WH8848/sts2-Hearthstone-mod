...
- **任务线卡类型标签**：`SpellCardTypePlaquePatch` 统一——带 Spell 或 Quest 关键词的卡显示"基础类型丨法术"（**分隔符用中文竖线"丨"**，不用 ASCII "|"）；任务线卡（禁忌序列/打开时空之门/巫师的计策/拖延时间/抵达传送大厅，底层 Power 类型）显示"能力丨法术"（改回，不用"任务"前缀）。

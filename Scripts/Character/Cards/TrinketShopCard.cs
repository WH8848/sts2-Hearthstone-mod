...
/// <summary>
/// 小玩物小屋 (Knickknack Shack) - 1费地标卡（罕见）。
/// 占随从槽，每两个回合可点击使用一次：
...
{
    /// <summary>
    /// 卡牌原画：炉石传说"小玩物小屋"（Knickknack Shack, PIP_059）官方原画
    /// </summary>
    public override string CustomPortraitPath => "res://assets/card_art/knickknack_shack.png";
